        ...
        <div className='md:h-screen bg-black  relative'>
            ...
            <div className='md:w-[80%] md:h-[100%] border-b-2 border-white md:grid md:grid-cols-2 md:gap-4 mx-auto '>
              <div className='md:text-left my-[100px]'>
                 <h1 className='text-[20px] md:text-[60px] text-white'>Nice to meet you! </h1>
                 <div className='mt-4 flex-col md:flex md:flex-row'>
                   <h1 className='md:text-[60px] text-white '>I'm  </h1> <h1 className=' md:w-100 border-b-2 border-[#4EE1A0] text-white md:text-[60px] md:border-[#4EE1A0] md:border-b-2 pb-0 md:ml-2' >Adeoye Sulaimon.</h1>
                 </div>
